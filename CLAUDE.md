...
- `/tmp` — bind to the host's `/var/tmp/devcontainer-<project>` (disk-backed; host `/tmp` is a small tmpfs). Survives rebuilds **and** reboots; the host's systemd-tmpfiles clears entries idle for 30+ days.
